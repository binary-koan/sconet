...
import {
  CategoryBudgetGroupResult,
  CategoryBudgetResult,
  MonthBudgetResult
} from "./resolvers/budgets"
...
export type AccountMailboxResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["AccountMailbox"] = ResolversParentTypes["AccountMailbox"]
> = {
...
export type CategoryBudgetResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["CategoryBudget"] = ResolversParentTypes["CategoryBudget"]
> = {
...
export type CategoryBudgetGroupResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["CategoryBudgetGroup"] = ResolversParentTypes["CategoryBudgetGroup"]
> = {
...
> = {
  ...
  exchangeRate: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<CurrencyExchangeRateArgs, "to">
  >
  id: Resolver<ResolversTypes["String"], ParentType, ContextType>
...
export type MonthBudgetResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["MonthBudget"] = ResolversParentTypes["MonthBudget"]
> = {
...
> = {
  ...
  >
  createAccountMailbox: Resolver<
    ResolversTypes["AccountMailbox"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateAccountMailboxArgs, "input">
  >
  ...
  >
  deleteAccountMailbox: Resolver<
    ResolversTypes["AccountMailbox"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteAccountMailboxArgs, "id">
  >
  ...
  >
  deleteCurrency: Resolver<
    ResolversTypes["Currency"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteCurrencyArgs, "id">
  >
  ...
  >
  reorderCategories: Resolver<
    Array<ResolversTypes["Category"]>,
    ParentType,
    ContextType,
    RequireFields<MutationReorderCategoriesArgs, "orderedIds">
  >
  splitTransaction: Resolver<
    ResolversTypes["Transaction"],
    ParentType,
    ContextType,
    RequireFields<MutationSplitTransactionArgs, "amounts" | "id">
  >
  updateAccountMailbox: Resolver<
    ResolversTypes["AccountMailbox"],
    ParentType,
    ContextType,
    RequireFields<MutationUpdateAccountMailboxArgs, "id" | "input">
  >
  ...
  updateCurrency: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationUpdateCurrencyArgs, "id" | "input">
  >
...
export type PaginatedTransactionsResolvers<
  ContextType = Context,
  ParentType extends ResolversParentTypes["PaginatedTransactions"] = ResolversParentTypes["PaginatedTransactions"]
> = {
...
> = {
  accountMailbox: Resolver<
    Maybe<ResolversTypes["AccountMailbox"]>,
    ParentType,
    ContextType,
    RequireFields<QueryAccountMailboxArgs, "id">
  >
  accountMailboxes: Resolver<Array<ResolversTypes["AccountMailbox"]>, ParentType, ContextType>
  budget: Resolver<
    ResolversTypes["MonthBudget"],
    ParentType,
    ContextType,
    RequireFields<QueryBudgetArgs, "month" | "timezoneOffset" | "year">
  >
  ...
  currency: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryCurrencyArgs, "id">
  >
  ...
  transactions: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryTransactionsArgs, "limit">
  >
}
