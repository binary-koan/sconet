...
export type CreateTransactionInput = {
  ...
  originalCurrencyCode?: InputMaybe<Scalars['CurrencyCode']['input']>;
};
...
export type Transaction = {
  ...
  originalCurrencyCode?: Maybe<Scalars['CurrencyCode']['output']>;
...
export type SplitTransactionMutation = { __typename?: 'Mutation', splitTransaction: { __typename?: 'Transaction', id: string } };
...
export type GetTransactionQuery = { __typename?: 'Query', transaction?: { __typename?: 'Transaction', id: string, memo: string, date: any, currencyCode: any, originalCurrencyCode?: any | null, includeInReports: boolean, splitFromId?: string | null, amount: { __typename?: 'Money', decimalAmount: number, formatted: string }, currency: { __typename?: 'Currency', code: any, symbol: string, decimalDigits: number }, originalAmount?: { __typename?: 'Money', decimalAmount: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, color: string, icon: string } | null, account: { __typename?: 'Account', id: string, name: string, currencyCode: any }, splitTo: Array<{ __typename?: 'Transaction', id: string, memo: string, includeInReports: boolean, amount: { __typename?: 'Money', decimalAmount: number, formatted: string }, originalAmount?: { __typename?: 'Money', decimalAmount: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, icon: string, color: string } | null }> } | null };
...
export type TransactionsQuery = { __typename?: 'Query', transactions: { __typename?: 'PaginatedTransactions', nextOffset?: string | null, data: Array<{ __typename?: 'Transaction', id: string, memo: string, date: any, currencyCode: any, originalCurrencyCode?: any | null, includeInReports: boolean, splitFromId?: string | null, amount: { __typename?: 'Money', decimalAmount: number, formatted: string }, originalAmount?: { __typename?: 'Money', decimalAmount: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, color: string, icon: string } | null, account: { __typename?: 'Account', id: string, name: string, currencyCode: any }, splitTo: Array<{ __typename?: 'Transaction', id: string, memo: string, includeInReports: boolean, amount: { __typename?: 'Money', decimalAmount: number, formatted: string }, originalAmount?: { __typename?: 'Money', decimalAmount: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, icon: string, color: string } | null }> }> } };
