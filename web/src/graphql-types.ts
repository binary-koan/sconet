...
/** Autogenerated input type of ApiKeyCreate */
...
/** Autogenerated return type of ApiKeyCreate. */
...
/** Autogenerated input type of ApiKeyRegenerate */
export type ApiKeyRegenerateInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['ID']['input'];
};

/** Autogenerated return type of ApiKeyRegenerate. */
export type ApiKeyRegeneratePayload = {
  __typename?: 'ApiKeyRegeneratePayload';
  apiKey: ApiKey;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
};

/** Autogenerated input type of ApiKeySetDisabled */
export type ApiKeySetDisabledInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
/** Autogenerated return type of ApiKeySetDisabled. */
export type ApiKeySetDisabledPayload = {
  __typename?: 'ApiKeySetDisabledPayload';
  apiKey: ApiKey;
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
};
...
/** A pixel rectangle to crop an image to */
...
/** Autogenerated input type of CurrencyCreate */
...
/** Autogenerated input type of FavouriteTransactionDelete */
export type FavouriteTransactionDeleteInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  id: Scalars['ID']['input'];
};

/** Autogenerated return type of FavouriteTransactionDelete. */
export type FavouriteTransactionDeletePayload = {
  __typename?: 'FavouriteTransactionDeletePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  favouriteTransaction: FavouriteTransaction;
};
...
/** Autogenerated return type of FavouriteTransactionUpsert. */
export type FavouriteTransactionUpsertPayload = {
  __typename?: 'FavouriteTransactionUpsertPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  favouriteTransaction: FavouriteTransaction;
};
...
export type Mutation = {
  ...
  /** Creates a new API key. The token is only returned once. */
  apiKeyCreate: ApiKeyCreatePayload;
  /** Replaces an API key's token. The old token stops working immediately and the new token is only returned once. */
  apiKeyRegenerate: ApiKeyRegeneratePayload;
  /** Disables or re-enables an API key */
  apiKeySetDisabled: ApiKeySetDisabledPayload;
  /** Reorders categories */
  ...
  /** Deletes a favourite transaction by ID */
  favouriteTransactionDelete: FavouriteTransactionDeletePayload;
  /** Creates or updates a favourite transaction setting for a shop */
  favouriteTransactionUpsert: FavouriteTransactionUpsertPayload;
  login: LoginPayload;
  /** Replaces a receipt image's file (e.g. with a client-rotated version) */
  receiptImageReplace: ReceiptImageReplacePayload;
  /** Creates a new transaction */
  transactionCreate: TransactionCreatePayload;
  /** Creates a placeholder transaction with an attached receipt image */
  transactionCreateFromReceipt: TransactionCreateFromReceiptPayload;
...
export type MutationApiKeyRegenerateArgs = {
  input: ApiKeyRegenerateInput;
};


export type MutationApiKeySetDisabledArgs = {
  input: ApiKeySetDisabledInput;
};
...
export type MutationFavouriteTransactionDeleteArgs = {
  input: FavouriteTransactionDeleteInput;
};


export type MutationFavouriteTransactionUpsertArgs = {
...
export type MutationReceiptImageReplaceArgs = {
  input: ReceiptImageReplaceInput;
};
...
export type MutationTransactionCreateFromReceiptArgs = {
  input: TransactionCreateFromReceiptInput;
};
...
export type Query = {
  ...
  currentUser: CurrentUser;
  favouriteTransactions: Array<FavouriteTransaction>;
...
/** Autogenerated input type of ReceiptImageReplace */
export type ReceiptImageReplaceInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
...
/** Autogenerated return type of ReceiptImageReplace. */
export type ReceiptImageReplacePayload = {
  __typename?: 'ReceiptImageReplacePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
...
/** Autogenerated input type of TransactionCreateFromReceipt */
export type TransactionCreateFromReceiptInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  crop?: InputMaybe<CropInput>;
...
/** Autogenerated return type of TransactionCreateFromReceipt. */
export type TransactionCreateFromReceiptPayload = {
  __typename?: 'TransactionCreateFromReceiptPayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  transaction: Transaction;
};
...
export type TransactionCreateInput = {
  /** Create the transaction even if one with the same amount, currency, and date already exists */
...
export type FullCategoryFragment = { __typename?: 'Category', id: string, name: string, color: string, icon: string, emoji?: string | null, description?: string | null, hasTransactions: boolean, isRegular: boolean, sortOrder: number, createdAt: any, updatedAt: any, budget?: { __typename?: 'CategoryBudget', budget: { __typename?: 'Money', amountDecimal: number, formatted: string }, currency: { __typename?: 'Currency', id: string } } | null };
...
export type CreateApiKeyMutation = { __typename?: 'Mutation', apiKeyCreate: { __typename?: 'ApiKeyCreatePayload', apiKey: { __typename?: 'ApiKey', id: string, token?: string | null } } };
...
export type RegenerateApiKeyMutation = { __typename?: 'Mutation', apiKeyRegenerate: { __typename?: 'ApiKeyRegeneratePayload', apiKey: { __typename?: 'ApiKey', id: string, token?: string | null } } };

export type SetApiKeyDisabledMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  disabled: Scalars['Boolean']['input'];
}>;


export type SetApiKeyDisabledMutation = { __typename?: 'Mutation', apiKeySetDisabled: { __typename?: 'ApiKeySetDisabledPayload', apiKey: { __typename?: 'ApiKey', id: string, disabledAt?: any | null } } };
...
export type CreateCurrencyMutation = { __typename?: 'Mutation', currencyCreate: { __typename?: 'CurrencyCreatePayload', currency: { __typename?: 'Currency', id: string } } };
...
export type CreateTransactionMutation = { __typename?: 'Mutation', transactionCreate: { __typename?: 'TransactionCreatePayload', transaction: { __typename?: 'Transaction', id: string, shop: string, memo: string, date: any, includeInReports: boolean, confirmed: boolean, amount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, currency?: { __typename?: 'Currency', id: string, code: string, symbol: string, decimalDigits: number } | null, shopAmount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, shopCurrency?: { __typename?: 'Currency', id: string } | null, category?: { __typename?: 'Category', id: string, name: string, color: string, icon: string } | null, account: { __typename?: 'Account', id: string, name: string, currency: { __typename?: 'Currency', id: string, code: string } }, receiptImages: Array<{ __typename?: 'ReceiptImage', id: string, url: string, filename: string, contentType: string, byteSize: number }>, splitTo: Array<{ __typename?: 'Transaction', id: string, memo: string, includeInReports: boolean, amount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, shopAmount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, icon: string, color: string } | null }> } } };
...
export type FavouriteTransactionDeleteMutationVariables = Exact<{
  id: Scalars['ID']['input'];
}>;


export type FavouriteTransactionDeleteMutation = { __typename?: 'Mutation', favouriteTransactionDelete: { __typename?: 'FavouriteTransactionDeletePayload', favouriteTransaction: { __typename?: 'FavouriteTransaction', id: string } } };

export type FavouriteTransactionUpsertMutationVariables = Exact<{
  name: Scalars['String']['input'];
  shop: Scalars['String']['input'];
  memo?: InputMaybe<Scalars['String']['input']>;
  priceCents?: InputMaybe<Scalars['Int']['input']>;
...
export type FavouriteTransactionUpsertMutation = { __typename?: 'Mutation', favouriteTransactionUpsert: { __typename?: 'FavouriteTransactionUpsertPayload', favouriteTransaction: { __typename?: 'FavouriteTransaction', id: string, name: string } } };
...
export type ReplaceReceiptImageMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  image: Scalars['Upload']['input'];
}>;


export type ReplaceReceiptImageMutation = { __typename?: 'Mutation', receiptImageReplace: { __typename?: 'ReceiptImageReplacePayload', transaction: { __typename?: 'Transaction', id: string } } };
...
export type CategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: string, name: string, color: string, icon: string, emoji?: string | null, description?: string | null, hasTransactions: boolean, isRegular: boolean, sortOrder: number, createdAt: any, updatedAt: any, budget?: { __typename?: 'CategoryBudget', budget: { __typename?: 'Money', amountDecimal: number, formatted: string }, currency: { __typename?: 'Currency', id: string } } | null }> };
...
export type FavouriteTransactionsQueryVariables = Exact<{ [key: string]: never; }>;


export type FavouriteTransactionsQuery = { __typename?: 'Query', favouriteTransactions: Array<{ __typename?: 'FavouriteTransaction', id: string, name: string, shop: string, memo: string, priceCents?: number | null, account?: { __typename?: 'Account', id: string, name: string, currency: { __typename?: 'Currency', id: string } } | null }> };
...
export type GetCategoryQuery = { __typename?: 'Query', category?: { __typename?: 'Category', id: string, name: string, color: string, icon: string, emoji?: string | null, description?: string | null, hasTransactions: boolean, isRegular: boolean, sortOrder: number, createdAt: any, updatedAt: any, budget?: { __typename?: 'CategoryBudget', budget: { __typename?: 'Money', amountDecimal: number, formatted: string }, currency: { __typename?: 'Currency', id: string } } | null } | null };
...
export type TransactionsQuery = { __typename?: 'Query', transactions: { __typename?: 'TransactionConnection', nodes: Array<{ __typename?: 'Transaction', id: string, shop: string, memo: string, date: any, includeInReports: boolean, confirmed: boolean, amount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, currency?: { __typename?: 'Currency', id: string } | null, shopAmount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, shopCurrency?: { __typename?: 'Currency', id: string } | null, category?: { __typename?: 'Category', id: string, name: string, color: string, icon: string } | null, account: { __typename?: 'Account', id: string, name: string, currency: { __typename?: 'Currency', id: string } }, splitTo: Array<{ __typename?: 'Transaction', id: string, memo: string, includeInReports: boolean, amount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, shopAmount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, icon: string, color: string } | null }> }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null } } };

export type UnconfirmedTransactionsQueryVariables = Exact<{ [key: string]: never; }>;


export type UnconfirmedTransactionsQuery = { __typename?: 'Query', transactions: { __typename?: 'TransactionConnection', nodes: Array<{ __typename?: 'Transaction', id: string, shop: string, memo: string, date: any, includeInReports: boolean, confirmed: boolean, amount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, currency?: { __typename?: 'Currency', id: string, code: string, symbol: string, decimalDigits: number } | null, shopAmount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, shopCurrency?: { __typename?: 'Currency', id: string } | null, category?: { __typename?: 'Category', id: string, name: string, color: string, icon: string } | null, account: { __typename?: 'Account', id: string, name: string, currency: { __typename?: 'Currency', id: string, code: string } }, receiptImages: Array<{ __typename?: 'ReceiptImage', id: string, url: string, filename: string, contentType: string, byteSize: number }>, splitTo: Array<{ __typename?: 'Transaction', id: string, memo: string, includeInReports: boolean, amount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, shopAmount?: { __typename?: 'Money', amountDecimal: number, formatted: string } | null, category?: { __typename?: 'Category', id: string, name: string, icon: string, color: string } | null }> }> } };
