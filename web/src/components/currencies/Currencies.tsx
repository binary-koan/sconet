...
export const CurrenciesList: Component<{
  ...
  return (
    <div class="flex flex-col">
      <div class="mb-6 flex items-center bg-card px-4 py-2 shadow-xs">
        <div class="min-w-0 flex-1">
          <div class="text-xs text-muted-foreground">Default currency</div>
      ...
      <div class="flex flex-col gap-px bg-border shadow-xs">
...
const Currency: Component<{
  ...
  return (
    <div class="flex items-center bg-card px-4 py-2 shadow-xs">
